...
import mindly.config.audit.AuditEventConverter;
import mindly.domain.PersistentAuditEvent;
...
import static mindly.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
